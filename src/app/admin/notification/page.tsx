...
export default function NotificationPage() {
 ...
 useEffect(() => {
   ...
   useEffect(() => {
      ...
      const handleSelectAll = () => {
        if (selectAll) {
          ...
          setSelectedClients(clients.map((client) => client._id)); // Select all clients
        }
  ...
  console.log("Client Data:", client._id); // Log each client

  return (
    <div key={client._id || index} className="grid grid-cols-[25px_1fr_1fr_1fr] items-center p-4 hover:bg-muted/50">
      <Checkbox
        checked={selectedClients.includes(client._id)}
        onCheckedChange={() => handleClientSelect(client._id)}
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <Tabs defaultValue="message" onValueChange={(value) => handleTypeChange(value as NotificationType)}>
                ...
                <TabsTrigger value="message" className="data-[state=active]:bg-[#4f46e5] data-[state=active]:text-white">
  Message
</TabsTrigger>
<TabsTrigger value="push" className="data-[state=active]:bg-[#4f46e5] data-[state=active]:text-white">
  Push
</TabsTrigger>
<TabsTrigger value="email" className="data-[state=active]:bg-[#4f46e5] data-[state=active]:text-white">
  Email
</TabsTrigger>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  label={`${notificationType.charAt(0).toUpperCase() + notificationType.slice(1)} title`}
                />
              </div>
